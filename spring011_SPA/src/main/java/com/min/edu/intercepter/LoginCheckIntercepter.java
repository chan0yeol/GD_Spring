...
@Slf4j
public class LoginCheckIntercepter implements AsyncHandlerInterceptor{@Override
	...
	// afterCompletion 요청 처리가 완료 되고 view가 렌더링 된 후에 호출 예외가 발생하면 afterCompletion 메소드에서 예외를 처리하고 다시 이벤트를 발생시킬 수 있다.
	@Override
